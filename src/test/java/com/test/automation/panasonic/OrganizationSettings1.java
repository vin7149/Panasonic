...
public class OrganizationSettings1 extends GlobalClass  {
public static void main(String[] args) throws IOException, InterruptedException {
	    ChromeBrowser();
	    driver.get(getUrl());
	   
	    driver.findElement(By.id("inputEmail3")).clear();
	    driver.findElement(By.id("inputEmail3")).sendKeys("vinauto72425@yopmail.com");
   ...
   /* if(driver.getCurrentUrl().contains("https://pidev.impressicocrm.com")) {
    ...
    waitforelement();
    Thread.sleep(20000);
    Select Level=new Select(driver.findElement(By.xpath("//select[@ng-reflect-model='0']")));
    waitforelement();
    Level.selectByValue("1");
    Thread.sleep(20000);
    Select LevelName=new Select(driver.findElement(By.xpath("html/body/app/main/pages/div/div/admin/organization-settings/div/div[2]/approval-level/div/div/div[1]/div[1]/div[2]/div/div[2]/select")));
    LevelName.selectByVisibleText("APPROVER");
    Thread.sleep(20000);
    ...
    //Select Planogram and Campaign for the user 
    driver.findElement(By.xpath("(//span[@class=\"onoffswitch-switch\"])[4]")).click();
